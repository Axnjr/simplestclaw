          ...
          {mode === 'hosted' && (
            <div className="mt-16">
              ...
              <div className="p-5 rounded-xl bg-white/[0.02] border border-white/10">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    ...
                    >
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#D4A27F">
                        <path d="M17.304 3.541l-5.357 16.918H8.079L2.646 3.541h3.921l3.311 11.368L13.18 3.541h4.124zm3.05 0l3.646 16.918h-3.667l-.637-3.452h-4.282l-.637 3.452H11.11L14.757 3.54h5.597zm-2.799 5.282l-1.312 5.94h2.625l-1.313-5.94z"/>
                      </svg>
                      <span className="text-[11px] text-white/60">Anthropic</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-[11px] text-white/60">OpenAI</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-[11px] text-white/60">Google</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-[11px] text-white/60">OpenRouter</span>
                    </button>
                  </div>
                </div>
              ...
              <p className="text-[12px] text-white/30 mt-3 text-center">
                {selectedProvider 
                  ? `You'll enter your ${selectedProvider === 'google' ? 'Google' : selectedProvider === 'openai' ? 'OpenAI' : selectedProvider === 'anthropic' ? 'Anthropic' : 'OpenRouter'} API key on Railway.`
